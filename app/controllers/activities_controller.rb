class ActivitiesController < ApplicationController
  ...
  def update
    ...
    redirect_to edit_user_trip_daily_itinerary_activity_path(current_user.id, params[:trip_id], params[:daily_itinerary_id], params[:id])
  end
  ...
  def activity_params
    params.permit(:name, :address, :expenses, :description)
  end
end
